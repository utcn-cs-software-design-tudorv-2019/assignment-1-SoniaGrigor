...
public class Bootsrap {
    ...
    private static void dropAll() throws SQLException {
        for (String schema : SCHEMAS) {
            ...
            String[] dropStatements = {
                    ...
                    "TRUNCATE `role`;",
                    "DROP TABLE  `student`, `role`, `group_`, ;"
            };
    ...
    private static void bootstrapTables() throws SQLException {
        ...
        for (String schema : SCHEMAS) {
            ...
            for (String table : Constants.Tables.ORDERED_TABLES_FOR_CREATION) {
                ...
                System.out.println("here " + createTableSQL);
    ...
    private static void bootstrapRoleRight() throws SQLException {
        ...
        for (String role : rolesRights.keySet()) {
            int roleId = rightsRolesRepository.findRoleByTitle(role).getId();

            for (String right : rolesRights.get(role)) {
                int rightId = rightsRolesRepository.findRightByTitle(right).getId();
